      ...
      <Card className="p-5 sm:p-6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-relaxed text-black/45">Перейдите на защищённую страницу оплаты, оплатите обучение и отправьте чек администратору своего филиала. После проверки администратор отметит оплату в кабинете.</p>
          </div>
        ...
        {canPay && (
          <>
            ...
            <div className="mt-3 rounded-[14px] border border-[#D96A24]/15 bg-[#D96A24]/[0.05] px-4 py-3 text-sm leading-6 text-[#6F4A32]">
              После оплаты сохраните чек и отправьте его администратору филиала. Статус «Оплачено» появится после подтверждения администратором.
            </div>
          </>
        )}
        {paymentUrl && child.paymentStatus === "paid" && <div className="mt-5 flex items-center gap-2 rounded-[14px] bg-[#5F6338]/[0.08] px-4 py-3 text-sm font-medium text-[#4D512E]"><CheckCircle2 className="h-4 w-4" /> Оплата подтверждена администратором.</div>}
      </Card>
