...
import { coins } from "@/data/demoData";
              ...
              <div className="mt-3 divide-y divide-black/[0.06]">
                {demoHistory.map((item) => (
                  ...
                  >
                    ...
                    <span className="shrink-0 text-base font-bold text-[#C95320]">
                      +{item.amount}
                    </span>
                  </div>
                ))}
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <p className="text-xs leading-relaxed text-black/45">
              Дополнительные Star Coin могут быть начислены
              администратором или администрацией школы за достижения,
              события и специальные активности.
            </p>
          </div>
        </div>
      </div>
      ...
      <Card className="p-5 sm:p-6">
        <div>
          ...
          <p
            ...
            "
          >
            За оценки и посещаемость Star Coin начисляются
            автоматически. Дополнительные достижения фиксирует
            администратор или администрация школы.
          </p>
        </div>
            ...
            {automaticRules.map((rule) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-4 text-sm font-semibold leading-snug text-[#171717]">
                    {rule.title}
                  </p>
        ...
        >
          ...
          <div>
            <p className="text-sm font-semibold text-[#171717]">
              За оценки и пропуски Star Coin не снимаются
            </p>

            <p className="mt-1 text-xs leading-relaxed text-black/45">
              Списание возможно только как отдельная корректировка
              администратора или администрации с указанием причины.
            </p>
          </div>
        </div>
      </Card>
