...
import { AlertTriangle, Archive, LoaderCircle, Plus, RotateCcw, Search, Trash2, UserX, X } from "lucide-react";
...
export function AdminStudentOperations() {
  ...
  const [keepPaymentConfirmed, setKeepPaymentConfirmed] = useState(false);
  ...
  async function confirmArchive() {
    ...
    if (archiveChild.refundableAmount > 0 && !keepPaymentConfirmed) {
      return setError("Сначала зафиксируйте возврат или подтвердите, что оплата остаётся в выручке.");
    }
