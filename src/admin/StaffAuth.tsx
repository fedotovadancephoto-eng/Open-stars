      ...
      <div className="grid min-h-screen lg:grid-cols-[1fr_0.9fr]">
        ...
        <div className="flex items-center justify-center px-5 py-10 sm:px-8">
          <div className="w-full max-w-md">
            ...
            <h2 className="mt-2 text-3xl font-semibold tracking-[-0.035em] text-[#171717]">Вход для сотрудников</h2>
            <p className="mt-2 text-sm leading-relaxed text-black/45">
              Используйте рабочий номер телефона и пароль.
            </p>
            ...
            <form onSubmit={handleSubmit} className="mt-7 space-y-4">
              ...
              <div>
                <label className="mb-2 block text-xs font-semibold text-[#171717]" htmlFor="staff-password">Пароль</label>
                <div className="relative">
